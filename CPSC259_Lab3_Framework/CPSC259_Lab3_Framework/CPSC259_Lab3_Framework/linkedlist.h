...
/* Insert your airplane structure here.  Use the correct types and names for the elements! */
 struct airplane {
	...
	int	priority; //(this will always be an integer)
	int	maximum_speed_kph;// (this will always be an integer)
	int	cruising_altitude;//(this will always be an integer)
	int	capacity;// (this will always be an integer).
...
struct node {
	struct node* next;
	struct airplane plane;// Add your member elements here
};
